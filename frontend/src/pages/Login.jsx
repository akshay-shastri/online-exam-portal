                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white px-8 py-8">
                    ...
                    <div className="space-y-5">
                        ...
                        <button
                            onClick={handleLogin}
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white py-3 rounded-xl text-sm font-bold transition-all duration-200 shadow-md hover:shadow-blue-200 hover:shadow-lg hover:-translate-y-0.5 flex items-center justify-center gap-2 mt-1 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0"
                        >
                            {loading ? (
                                <>
                    ...
                    <p className="text-center text-sm text-gray-500">
                        ...
                        <Link to="/register" className="text-blue-600 font-semibold hover:text-indigo-600 transition-colors">
                            Create one
                        </Link>
                    </p>
